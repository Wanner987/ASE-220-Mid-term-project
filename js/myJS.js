...
//loads the Articles in the HTML element
        ...
        <div class="blog-post-container grid-layout">
                <div class="blog-post-inner blog-post" data-id="${article.id}">
                    ...
                    <div class="blog-post-detail">
                        ...
                        <div class="post-meta">
                            <ul>
                                <li class="entry-date published likeCount">Likes:${article.likes}</li>
...
//Nav Bar buttons/forms

//generates a random ID for the Articles
...
$("#register").submit(function (event) {
    ...
    $("#register").modal("hide");
    alert("Your Password and UserName have been added! Please Login");
});
...
$(document).on('click', '.likeButton', function() {
    const articleId = parseInt($(this).closest('.blog-post').attr('data-id'));
    ...
    if (article) {
        ...
        updateJSONBlob();
        findMostLikedArticle();
        $(this).closest('.blog-post').find('.likeCount').text(`Like: ${article.likes}`);
    }
});
